...
async function main() {
  ...
  const context = [];
  let playing = true;
  const location = "the 5th circle of hell";
  const player = {};
  ...
  The theme of the game is dark, brooding, and macabre. There is some foul beast tracking the player but
  the player can never see them. The player doesn't know the beast is following them, make sure to bring it up
  later in the story
